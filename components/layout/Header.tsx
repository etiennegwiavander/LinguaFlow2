...
export default function Header({ className, sidebarCollapsed }: HeaderProps) {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-30 flex h-16 w-full items-center glass-nav shadow-lg border-b border-cyber-400/20",
        className
      )}
    >
      <div className={cn(
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="h-8 w-8 sm:h-9 sm:w-9 hover:bg-cyber-400/10 hover:text-cyber-400 transition-all duration-300 focus-cyber">
            ...
            <DropdownMenuContent align="end" className="glass-effect border-cyber-400/30">
              <DropdownMenuItem onClick={() => setTheme("light")} className="hover:bg-cyber-400/10 focus-cyber">
                Light
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setTheme("dark")} className="hover:bg-cyber-400/10 focus-cyber">
                Dark
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setTheme("system")} className="hover:bg-cyber-400/10 focus-cyber">
                System
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
