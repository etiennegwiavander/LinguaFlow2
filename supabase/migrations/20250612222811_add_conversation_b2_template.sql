-- Insert Conversation B2 Lesson Template
INSERT INTO lesson_templates (name, category, level, template_json)
VALUES (
  'B2 Conversation Lesson',
  'Conversation',
  'b2',
  '{
    "name": "B2 Conversation Lesson",
    ...
    "sections": [
      ...
      },
      {
        ...
        "instruction": "Read or listen to the following passage/dialogue to model natural language use.",
        "instruction_bg_color_var": "secondary_bg",
      ...
      },
      {
        ...
        "instruction": "Answer these questions to check your understanding of the dialogue/reading.",
        "instruction_bg_color_var": "secondary_bg",
