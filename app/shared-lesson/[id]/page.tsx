  ...
  const renderExerciseContent = (section: TemplateSection) => {
    ...
    switch (contentType) {
      ...
      case 'matching': {
          ...
          return (
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="border-2 border-cyan-400/30 rounded-lg p-4 bg-cyan-50/30 dark:bg-cyan-900/20">
                  <h4 className="font-semibold text-lg mb-2 text-cyan-600 dark:text-cyan-400">Sound 1</h4>
                  {/* <p className="text-sm text-gray-600 dark:text-gray-400">Drag words here</p> */}
                </div>
                <div className="border-2 border-purple-400/30 rounded-lg p-4 bg-purple-50/30 dark:bg-purple-900/20">
                  <h4 className="font-semibold text-lg mb-2 text-purple-600 dark:text-purple-400">Sound 2</h4>
                  {/* <p className="text-sm text-gray-600 dark:text-gray-400">Drag words here</p> */}
                </div>
              </div>
        ...
        // Regular matching pairs exercise
