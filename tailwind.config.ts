  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'neon-lg': '0 0 10px theme(colors.neon.400), 0 0 40px theme(colors.neon.400), 0 0 70px theme(colors.neon.400)',
        'cyber': '0 0 5px theme(colors.cyber.400), 0 0 5px theme(colors.cyber.400), 0 0 15px theme(colors.cyber.400)',
        'cyber-lg': '0 0 10px theme(colors.cyber.400), 0 0 10px theme(colors.cyber.400), 0 0 30px theme(colors.cyber.400)',
        'white-glow': '0 0 10px rgba(255, 255, 255, 0.5), 0 0 20px rgba(255, 255, 255, 0.3), 0 0 30px rgba(255, 255, 255, 0.2)',
      },
    },
  },
